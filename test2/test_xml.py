...
class XULTestCase(CodeIntelTestCase):
    ...
    def test_trg_from_pos(self):
        ...
        self.assertTriggerMatches(
            xmlprefix+"<<|>", name="xml-complete-tags-and-namespaces")
        self.assertNoTrigger(xmlprefix+"<![CDATA[ <<|>")
        self.assertNoTrigger(xmlprefix+"<!DOCTYPE <|>")
        self.assertNoTrigger(xmlprefix+"<?<|>")
        self.assertTriggerMatches(
            xmlprefix+"<!<|>", name="xml-complete-gt-bang")
        self.assertTriggerMatches(
            xmlprefix+"<ns:<|>", name="xml-complete-ns-tags")
        self.assertTriggerMatches(
            xmlprefix+"<ns:name <|>", name="xml-complete-tag-attrs")
        # The second ":" is ignored, treated like a tagname char
        self.assertNoTrigger(xmlprefix+"<ns:name:<|>")
        self.assertTriggerMatches(
            xmlprefix+"<ns:name: <|>", name="xml-complete-tag-attrs")
        self.assertTriggerMatches(
            xmlprefix+"<elt <|>", name="xml-complete-tag-attrs")
        # Erroneous XML here, but fallback is to stay in start-tag mode.
        self.assertTriggerMatches(
            xmlprefix+"<ns: <|>", name="xml-complete-tag-attrs")
        self.assertTriggerMatches(
            xmlprefix+"<ns:elt <|>", name="xml-complete-tag-attrs")
        self.assertTriggerMatches(
            xmlprefix+"<ns:elt attr1='val1' <|>", name="xml-complete-tag-attrs")
        self.assertTriggerMatches(
            xmlprefix+"<ns:elt attr2=\"val2\" <|>", name="xml-complete-tag-attrs")
        # self.assertTriggerMatches("<ns:elt attr3=val1 <|>", name="xml-
        # complete-tag-attrs")
        self.assertTriggerMatches(
            xmlprefix+"<ns:elt\t<|>", name="xml-complete-tag-attrs")
        self.assertTriggerMatches(
        ...
        # Attributes
        self.assertTriggerMatches(
            xmlprefix+"<x:foo y:<|>", name="xml-complete-ns-tags-attrs")
        ...
        self.assertTriggerMatches(
            xmlprefix+"<x xmlns:pfx1='urn:bogus' xmlns:<|>",
            name="xml-complete-well-known-ns")
    ...
    def test_completions(self):
        ...
        self.assertCompletionsAre(
            xmlprefix+"<x xmlns:<|>", common_namespace_cplns)
        self.assertCompletionsAre(doclet1 + "</<|>", [('element', 'c2>')])
        self.assertCompletionsAre(
            doclet1 + "</c2  >  </<|>", [('element', 'c1>')])
        self.assertCompletionsAre(
            doclet1 + "<c3 a='1'>blah</c3></c2  >  </<|>", [('element', 'c1>')])
    ...
    def test_preceding_trg_from_pos(self):
        ...
        self.assertPrecedingTriggerMatches(
            xmlprefix+"<<|><$>", name="xml-complete-tags-and-namespaces", pos=1+plen)
        self.assertPrecedingTriggerMatches(
            xmlprefix+"<!<|><$>", name="xml-complete-gt-bang", pos=2+plen)
        self.assertPrecedingTriggerMatches(
            xmlprefix+"<!DOC<|><$>TYPE", name="xml-complete-gt-bang", pos=2+plen)
        self.assertPrecedingTriggerMatches(
            xmlprefix+"<<|><$>!DOCTYPE", name="xml-complete-tags-and-namespaces", pos=1+plen)

        self.assertPrecedingTriggerMatches(
            xmlprefix+"<c1  >  </<|><$>", name="xml-complete-end-tag")
        self.assertPrecedingTriggerMatches(
            xmlprefix+"<na<$><|>me", name="xml-complete-tags-and-namespaces", pos=1+plen)

        # ns tags
        self.assertPrecedingTriggerMatches(
            xmlprefix+"<ns:name<$><|>", name="xml-complete-ns-tags", pos=4+plen)
        self.assertPrecedingTriggerMatches(
            xmlprefix+"<ns:<$><|>", name="xml-complete-ns-tags", pos=4+plen)
        self.assertPrecedingTriggerMatches(
            xmlprefix+"<ns:na<$><|>me", name="xml-complete-ns-tags", pos=4+plen)

        # namespaces
        self.assertPrecedingTriggerMatches(
            xmlprefix+"<x xmlns:<|><$>", name="xml-complete-well-known-ns")

        # attributes
        self.assertPrecedingTriggerMatches(
            xmlprefix+"<ns:name <|><$>", name="xml-complete-tag-attrs")
        self.assertPrecedingTriggerMatches(
            xmlprefix+"<ns:name foo<|><$>", name="xml-complete-tag-attrs")
        self.assertPrecedingTriggerMatches(
            xmlprefix+"<ns:name foo:bar<|><$>", name="xml-complete-ns-tags-attrs")
        self.assertPrecedingTriggerMatches(
            xmlprefix+"<x a='<|><$>", name="xml-complete-attr-enum-values")
        self.assertPrecedingTriggerMatches(
            xmlprefix+'<x a="<|><$>', name="xml-complete-attr-enum-values")
        self.assertPrecedingTriggerMatches(
            xmlprefix+"<x a='foo<|><$>", name="xml-complete-attr-enum-values")
        self.assertPrecedingTriggerMatches(
            xmlprefix+'<x a="foo<|><$>', name="xml-complete-attr-enum-values")
        self.assertPrecedingTriggerMatches(
            xmlprefix+"<x ns:a='<|><$>", name="xml-complete-attr-enum-values")
        self.assertPrecedingTriggerMatches(
            xmlprefix+'<x ns:a="<|><$>', name="xml-complete-attr-enum-values")
