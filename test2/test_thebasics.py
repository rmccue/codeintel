...
class HTMLTestCase(_TheBasicsTestCase):
    ...
    def test_calltips(self):
        ...
        self.assertCalltipIs(
            "<style> selector { font-weight:<|> asdf; } </style>",
    ...
    def test_script_onx_attrs_dquotes(self):
        ...
        """
        self.assertCompletionsInclude(
            script.replace("parseInt", "par<|>seInt"),
            [("function", "parseFloat"),
             ("function", "parseInt"), ])
...
class XSLTTestCase(XMLTestCase):
    ...
    def test_cplns(self):
        ...
        self.assertCompletionsInclude(
            xslt_prefix+"<xsl:template match='asdf'>\n<html><<|>",
            [("element", "body")])
